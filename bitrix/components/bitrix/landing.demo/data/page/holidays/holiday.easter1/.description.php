	...
	data-pagi-classes="u-carousel-indicators-v1--white g-absolute-centered--x g-bottom-20">
		...
		<div class="landing-block-node-card js-slide">
			<div class="landing-block-node-card-bgimg g-flex-centered g-min-height-100vh h-100 g-bg-pos-center g-bg-img-hero g-bg-cover g-bg-black-opacity-0_5--after" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/993x655/img1.jpg\');" data-fileid="-1">
				<div class="text-center g-pos-rel container g-max-width-800 g-z-index-1 landing-block-node-card-container js-animation fadeInLeft">
					...
					<div class="landing-block-node-card-text g-line-height-1_1 g-font-weight-100 g-color-white g-mb-10 g-mb-20--md"><p><span style="color: rgb(245, 245, 245);">Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in.</span></p></div>
        ...
        <div class="landing-block-node-texts col-lg-7 g-pt-100 g-pb-80 g-px-15 g-px-40--md g-bg-primary">
            <header class="landing-block-node-header text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
                <h6 class="landing-block-node-subtitle g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-mb-20 g-color-white-opacity-0_8 text-left">About us</h6>
                <h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-color-white g-mb-minus-10 text-left g-font-size-50--md text-uppercase g-font-size-35">we are the best<br /></h2>
            </header>
        ...
        <div class="container">
            <div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
                <h6 class="landing-block-node-subtitle g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-color-primary g-mb-20">Our products</h6>
                <h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-mb-minus-10 text-uppercase">Choose your egg<br /></h2>
            </div>
        </div>
    </section>',
			],
				...
				<div class="row landing-block-inner">
						...
						<article class="media">
							...
							<div class="media-body align-self-center g-pl-10">
								<div class="d-flex justify-content-between u-heading-v1-4 g-bg-main g-brd-gray-light-v4 g-mb-8">
									<h3 class="landing-block-node-card-title align-self-center u-heading-v1__title g-font-weight-700 g-font-size-13 text-uppercase mb-0">with flowers</h3>
					...
					<div class="landing-block-node-card js-animation col-md-6 g-mb-50 fadeInUp">
						...
						<article class="media">
							...
							<div class="media-body align-self-center g-pl-10">
								<div class="d-flex justify-content-between u-heading-v1-4 g-bg-main g-brd-gray-light-v4 g-mb-8">
									<h3 class="landing-block-node-card-title align-self-center u-heading-v1__title g-font-weight-700 g-font-size-13 text-uppercase mb-0">blue-green streaks<br /></h3>
					...
					<div class="landing-block-node-card js-animation col-md-6 g-mb-50 fadeInUp">
						...
						<article class="media">
							...
							<div class="media-body align-self-center g-pl-10">
								<div class="d-flex justify-content-between u-heading-v1-4 g-bg-main g-brd-gray-light-v4 g-mb-8">
									<h3 class="landing-block-node-card-title align-self-center u-heading-v1__title g-font-weight-700 g-font-size-13 text-uppercase mb-0">multicolor streaks</h3>
					...
					<div class="landing-block-node-card js-animation col-md-6 g-mb-50 fadeInUp">
						...
						<article class="media">
							...
							<div class="media-body align-self-center g-pl-10">
								<div class="d-flex justify-content-between u-heading-v1-4 g-bg-main g-brd-gray-light-v4 g-mb-8">
									<h3 class="landing-block-node-card-title align-self-center u-heading-v1__title g-font-weight-700 g-font-size-13 text-uppercase mb-0">blue<br /></h3>
					...
					<div class="landing-block-node-card js-animation col-md-6 g-mb-50 fadeInUp">
						...
						<article class="media">
							...
							<div class="media-body align-self-center g-pl-10">
								<div class="d-flex justify-content-between u-heading-v1-4 g-bg-main g-brd-gray-light-v4 g-mb-8">
									<h3 class="landing-block-node-card-title align-self-center u-heading-v1__title g-font-weight-700 g-font-size-13 text-uppercase mb-0">polka-dot</h3>
					...
					<div class="landing-block-node-card js-animation col-md-6 g-mb-50 fadeInUp">
						...
						<article class="media">
							...
							<div class="media-body align-self-center g-pl-10">
								<div class="d-flex justify-content-between u-heading-v1-4 g-bg-main g-brd-gray-light-v4 g-mb-8">
									<h3 class="landing-block-node-card-title align-self-center u-heading-v1__title g-font-weight-700 g-font-size-13 text-uppercase mb-0">pink</h3>
	...
	<div class="container">
				...
				<article class="row flex-items-middle text-center">
					<div class="col-lg-6 align-self-center g-mb-50">
						<div class="text-uppercase text-center g-mb-20">
							...
							<h2 class="landing-block-node-card-title landing-semantic-title-medium-bg-before js-animation fadeInLeft g-line-height-1_2 g-font-weight-700 h1 g-color-white u-heading-v2-12--1 g-mb-40 g-brd-white text-center">sugar rabbit and cake<br /></h2>
						</div>
						...
						<div class="landing-block-node-card-button-container">
							<a class="landing-block-node-card-button btn g-btn-type-solid g-btn-size-special g-btn-px-m g-btn-white text-uppercase g-btn-white g-color-gray-dark-v2 rounded-0 g-py-25 js-animation fadeIn" href="#">Book now
							</a>
						</div>
					</div>
        ...
        <div class="container">
            <div class="landing-block-node-header text-uppercase text-center u-heading-v2-4--bottom g-brd-primary g-mb-80 js-animation fadeIn">
                <h6 class="landing-block-node-title g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-color-primary g-mb-20">other cake&amp;#039;s shapes</h6>
                <h2 class="landing-block-node-subtitle h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-mb-minus-10 g-font-size-38">CHOOSE ANYTHING YOU LIKE</h2>
            </div>
                ...
                <div class="landing-block-node-element landing-block-card col-md-6 col-lg-3 g-parent g-brd-around g-brd-gray-light-v4 g-brd-bottom-primary--hover g-brd-bottom-2--hover g-mb-30 g-mb-0--lg g-transition-0_2 g-transition--ease-in js-animation fadeInLeft">
					...
					<span class="landing-block-node-element-icon-container d-block g-color-primary g-font-size-40 g-mb-15">
					  <i class="landing-block-node-element-icon icon-science-100 u-line-icon-pro"></i>
                        ...
                        <h5 class="landing-block-node-element-title text-uppercase g-mb-10">moon shape</h5>
                        <div class="landing-block-node-element-text g-font-size-13--md"><span style="color: rgb(167, 167, 167); font-family: Montserrat, Helvetica, Arial, sans-serif;"> Vivamus a fringilla lorem, vel faucibus ante.</span></div>
                ...
                <div class="landing-block-node-element landing-block-card col-md-6 col-lg-3 g-parent g-brd-around g-brd-gray-light-v4 g-brd-bottom-primary--hover g-brd-bottom-2--hover g-mb-30 g-mb-0--md g-ml-minus-1 g-transition-0_2 g-transition--ease-in js-animation fadeInLeft">
					...
					<span class="landing-block-node-element-icon-container d-block g-color-primary g-font-size-40 g-mb-15">
					  <i class="landing-block-node-element-icon icon-media-119 u-line-icon-pro"></i>
                        ...
                        <h5 class="landing-block-node-element-title text-uppercase g-mb-10">star shape</h5>
                        <div class="landing-block-node-element-text g-font-size-13--md"><span style="color: rgb(167, 167, 167); font-family: Montserrat, Helvetica, Arial, sans-serif;"> Vivamus a fringilla lorem, vel faucibus ante.</span></div>
                ...
                <div class="landing-block-node-element landing-block-card col-md-6 col-lg-3 g-parent g-brd-around g-brd-gray-light-v4 g-brd-bottom-primary--hover g-brd-bottom-2--hover g-mb-30 g-mb-0--md g-ml-minus-1 g-transition-0_2 g-transition--ease-in js-animation fadeInLeft">
					...
					<span class="landing-block-node-element-icon-container d-block g-color-primary g-font-size-40 g-mb-15">
					  <i class="landing-block-node-element-icon icon-medical-022 u-line-icon-pro"></i>
                        ...
                        <h5 class="landing-block-node-element-title text-uppercase g-mb-10">heart shape</h5>
                        <div class="landing-block-node-element-text g-font-size-13--md"><span style="color: rgb(167, 167, 167); font-family: Montserrat, Helvetica, Arial, sans-serif;"> Vivamus a fringilla lorem, vel faucibus ante.</span></div>
                ...
                <div class="landing-block-node-element landing-block-card col-md-6 col-lg-3 g-parent g-brd-around g-brd-gray-light-v4 g-brd-bottom-primary--hover g-brd-bottom-2--hover g-mb-30 g-mb-0--md g-ml-minus-1 g-transition-0_2 g-transition--ease-in js-animation fadeInLeft">
					...
					<span class="landing-block-node-element-icon-container d-block g-color-primary g-font-size-40 g-mb-15">
					  <i class="landing-block-node-element-icon icon-finance-145 u-line-icon-pro"></i>
                        ...
                        <h5 class="landing-block-node-element-title text-uppercase g-mb-10">diamond shape</h5>
                        <div class="landing-block-node-element-text g-font-size-13--md"><span style="color: rgb(167, 167, 167); font-family: Montserrat, Helvetica, Arial, sans-serif;"> Vivamus a fringilla lorem, vel faucibus ante.</span></div>
        ...
        <div class="container">
            <div class="landing-block-node-inner text-uppercase text-center u-heading-v2-4--bottom g-brd-primary">
                <h6 class="landing-block-node-subtitle g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-mb-20 g-color-white-opacity-0_8">special offers</h6>
                <h2 class="landing-block-node-title h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-mb-minus-10 g-color-white g-font-size-38">easter cookies<br /></h2>
            </div>
        </div>
    </section>',
			],
	...
	<div class="container">
		...
		<div class="row landing-block-inner">
			<div class="landing-block-card-employee js-animation col-md-6 col-lg-3 g-mb-30 g-mb-0--lg fadeIn">
				<div class="text-center">
					...
					<h4 class="landing-block-node-employee-name text-uppercase g-font-weight-700 g-font-size-18 g-mb-7">green cookie</h4>
					<div class="landing-block-node-employee-subtitle g-font-size-13 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
					<!-- End Figure Info-->
				</div>
			</div>
			...
			<div class="landing-block-card-employee js-animation col-md-6 col-lg-3 g-mb-30 g-mb-0--lg fadeIn">
				<div class="text-center">
					...
					<h4 class="landing-block-node-employee-name text-uppercase g-font-weight-700 g-font-size-18 g-mb-7">yellow cookie</h4>
					<div class="landing-block-node-employee-subtitle g-font-size-13 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
					<!-- End Figure Info-->
				</div>
			</div>
			...
			<div class="landing-block-card-employee js-animation col-md-6 col-lg-3 g-mb-30 g-mb-0--md fadeIn">
				<div class="text-center">
					...
					<h4 class="landing-block-node-employee-name text-uppercase g-font-weight-700 g-font-size-18 g-mb-7">blue cookie</h4>
					<div class="landing-block-node-employee-subtitle g-font-size-13 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
					<!-- End Figure Info-->
				</div>
			</div>
			...
			<div class="landing-block-card-employee js-animation col-md-6 col-lg-3 fadeIn">
				<div class="text-center">
					...
					<h4 class="landing-block-node-employee-name text-uppercase g-font-weight-700 g-font-size-18 g-mb-7">pink cookie</h4>
					<div class="landing-block-node-employee-subtitle g-font-size-13 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
					<!-- End Figure Info-->
				</div>
			</div>
        ...
        <div class="container landing-block-node-subcontainer text-center g-max-width-800">
            ...
            <div class="landing-block-node-inner text-uppercase u-heading-v2-4--bottom g-brd-primary">
                ...
                <h2 class="landing-block-node-title u-heading-v2__title g-line-height-1_1 g-font-weight-700 g-mb-minus-10 g-font-size-38">Contact us</h2>
            </div>
			<div class="landing-block-node-text"><p>Etiam ultrices lacus ut ligula vestibulum, sit amet mattis nunc elementum. Nam arcu enim, euismod nec purus non, aliquam congue ante. Nulla faucibus enim mauris, fringilla mollis ligula sollicitudin mollis.</p></div>
        </div>
    </section>',
			],
		'33.23.form_2_themecolor_no_text' =>
			[
				...
				'SORT' => '5500',
				'CONTENT' => '<section class="g-pos-rel landing-block g-pt-80 g-pb-80 g-bg-primary">
