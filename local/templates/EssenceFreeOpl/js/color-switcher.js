...
jQuery('head').append('<link rel="stylesheet" id="colors" href="local/templates/EssenceFreeOpl/css/colors/preset.css" type="text/css" />');
jQuery('head').append('<link rel="stylesheet" href="local/templates/EssenceFreeOpl/css/color-switcher.css" type="text/css" />');
